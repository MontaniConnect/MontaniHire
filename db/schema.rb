...
ActiveRecord::Schema[8.1].define(version: 2026_06_25_080000) do
  ...
  create_table "candidates", force: :cascade do |t|
    ...
    t.boolean "preliminary_interview_no_show", default: false, null: false
    t.text "recruiter_notes"
    t.datetime "rejection_email_sent_at"
